...
namespace ShopTemplate.Migrations
{
    ...
    [Migration("20181214174349_seedUpdated4")]
    partial class seedUpdated4
    {
            ...
            modelBuilder.Entity("ShopTemplate.Models.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CategoryId = 1, Description = "Gold beautifull wedding ring", ImagePath = "images/products/productImage_1.png", Name = "Ring", Price = 499m },
